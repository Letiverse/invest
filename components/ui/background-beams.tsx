  ...
  return (
    <div className={cn('pointer-events-none absolute inset-0 h-full w-full', className)}>
      ...
      >
        ...
        <defs>
          {pathData.map((_, i) => (
            <linearGradient key={`bbg-${i}`} id={`bbg-${i}`} x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%"   stopColor="#34E9E2" stopOpacity="0" />
              <stop offset="20%"  stopColor="#34E9E2" stopOpacity="1" />
              <stop offset="50%"  stopColor="#34E9E2" stopOpacity="1" />
              <stop offset="80%"  stopColor="#98F8F3" stopOpacity="1" />
              <stop offset="100%" stopColor="#98F8F3" stopOpacity="0" />
            </linearGradient>
          ))}
        </defs>
      </svg>
