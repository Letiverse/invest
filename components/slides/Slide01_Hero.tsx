    ...
    <SlideFrame>
      ...
      >
        ...
        <div style={{ position: "absolute", left: 160.0, top: 881.9, width: 1600.0, height: 155.1 }}>
          <p style={{ textAlign: "left", margin: 0, padding: 0, lineHeight: 1.15, whiteSpace: "normal" }}><span style={{ fontSize: "48.0px", fontWeight: 700, letterSpacing: "-0.5px", color: "#34E9E2" }}>£<NumberTicker value={995000} delay={0.6} /> </span><span style={{ fontSize: "28.0px", letterSpacing: "2.0px", color: "#FFFFFF" }}>RAISE</span><span style={{ fontSize: "48.0px", fontWeight: 700, color: "rgba(255,255,255,0.350)" }}>  |  </span><span style={{ fontSize: "48.0px", fontWeight: 700, letterSpacing: "-0.5px", color: "#34E9E2" }}>£<NumberTicker value={50} delay={0.8} /> </span><span style={{ fontSize: "28.0px", letterSpacing: "2.0px", color: "#FFFFFF" }}>SHARE PRICE</span><span style={{ fontSize: "48.0px", fontWeight: 700, color: "rgba(255,255,255,0.350)" }}>  |  </span><span style={{ fontSize: "48.0px", fontWeight: 700, letterSpacing: "-0.5px", color: "#34E9E2" }}>£<NumberTicker value={1000} delay={1} /> </span><span style={{ fontSize: "28.0px", letterSpacing: "2.0px", color: "#FFFFFF" }}>MIN BUY-IN</span><span style={{ fontSize: "48.0px", fontWeight: 700, color: "rgba(255,255,255,0.350)" }}>  | </span><span style={{ fontSize: "28.0px", letterSpacing: "2.0px", color: "#FFFFFF" }}>CLOSES</span><span style={{ fontSize: "48.0px", letterSpacing: "2.0px", color: "#FFFFFF" }}> </span><span style={{ fontSize: "48.0px", letterSpacing: "2.0px", color: "#34E9E2" }}>18</span><span style={{ fontSize: "31.2px", letterSpacing: "2.0px", verticalAlign: "super", color: "#34E9E2" }}>TH</span><span style={{ fontSize: "48.0px", letterSpacing: "2.0px", color: "#FFFFFF" }}> </span><span style={{ fontSize: "48.0px", fontWeight: 700, letterSpacing: "-0.5px", color: "#34E9E2" }}>OCTOBER 2026</span></p>
